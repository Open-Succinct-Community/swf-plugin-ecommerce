...
public class TrackSpecialHandlingType implements java.io.Serializable {
    ...
    public static final TrackSpecialHandlingType BATTERY = new TrackSpecialHandlingType(_BATTERY);
    ...
    public static final TrackSpecialHandlingType ELECTRONIC_DOCUMENTS_WITH_ORIGINALS = new TrackSpecialHandlingType(_ELECTRONIC_DOCUMENTS_WITH_ORIGINALS);
    ...
    public static final TrackSpecialHandlingType ELECTRONIC_TRADE_DOCUMENTS = new TrackSpecialHandlingType(_ELECTRONIC_TRADE_DOCUMENTS);
    ...
    public static final TrackSpecialHandlingType OVER_LENGTH = new TrackSpecialHandlingType(_OVER_LENGTH);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackSpecialHandlingType"));
    }
    /**
