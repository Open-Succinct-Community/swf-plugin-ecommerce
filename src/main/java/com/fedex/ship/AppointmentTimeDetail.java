...
public class AppointmentTimeDetail  implements java.io.Serializable {
    ...
    private com.fedex.ship.AppointmentWindowType type;

    /* Specifies the window of time for an appointment. */
    private com.fedex.ship.LocalTimeRange window;
    ...
    public AppointmentTimeDetail(
           com.fedex.ship.AppointmentWindowType type,
           com.fedex.ship.LocalTimeRange window,
     ...
     * window being specified.
     */
    public com.fedex.ship.AppointmentWindowType getType() {
        return type;
    }
     ...
     * window being specified.
     */
    public void setType(com.fedex.ship.AppointmentWindowType type) {
        this.type = type;
    }
     ...
     */
    public com.fedex.ship.LocalTimeRange getWindow() {
        return window;
    }
     ...
     */
    public void setWindow(com.fedex.ship.LocalTimeRange window) {
        this.window = window;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "AppointmentTimeDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "AppointmentWindowType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("window");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Window"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "LocalTimeRange"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
