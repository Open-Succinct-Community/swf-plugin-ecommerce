...
public class ShipmentEventNotificationDetail  implements java.io.Serializable {
    private com.fedex.rate.stub.ShipmentNotificationAggregationType aggregationType;

    private java.lang.String personalMessage;

    private com.fedex.rate.stub.ShipmentEventNotificationSpecification[] eventNotifications;

    public ShipmentEventNotificationDetail() {
    }

    public ShipmentEventNotificationDetail(
           com.fedex.rate.stub.ShipmentNotificationAggregationType aggregationType,
           java.lang.String personalMessage,
           com.fedex.rate.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
     ...
     */
    public com.fedex.rate.stub.ShipmentNotificationAggregationType getAggregationType() {
        return aggregationType;
    }
     ...
     */
    public void setAggregationType(com.fedex.rate.stub.ShipmentNotificationAggregationType aggregationType) {
        this.aggregationType = aggregationType;
    }
     ...
     */
    public com.fedex.rate.stub.ShipmentEventNotificationSpecification[] getEventNotifications() {
        return eventNotifications;
    }
     ...
     */
    public void setEventNotifications(com.fedex.rate.stub.ShipmentEventNotificationSpecification[] eventNotifications) {
        this.eventNotifications = eventNotifications;
    }

    public com.fedex.rate.stub.ShipmentEventNotificationSpecification getEventNotifications(int i) {
        return this.eventNotifications[i];
    }

    public void setEventNotifications(int i, com.fedex.rate.stub.ShipmentEventNotificationSpecification _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ShipmentEventNotificationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("aggregationType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "AggregationType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ShipmentNotificationAggregationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("personalMessage");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "PersonalMessage"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "EventNotifications"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ShipmentEventNotificationSpecification"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
