...
public class ShipmentEventNotificationDetail  implements java.io.Serializable {
    private com.fedex.ship.ShipmentNotificationAggregationType aggregationType;

    private java.lang.String personalMessage;

    private com.fedex.ship.ShipmentEventNotificationSpecification[] eventNotifications;

    public ShipmentEventNotificationDetail() {
    }

    public ShipmentEventNotificationDetail(
           com.fedex.ship.ShipmentNotificationAggregationType aggregationType,
           java.lang.String personalMessage,
           com.fedex.ship.ShipmentEventNotificationSpecification[] eventNotifications) {
     ...
     */
    public com.fedex.ship.ShipmentNotificationAggregationType getAggregationType() {
        return aggregationType;
    }
     ...
     */
    public void setAggregationType(com.fedex.ship.ShipmentNotificationAggregationType aggregationType) {
        this.aggregationType = aggregationType;
    }
     ...
     */
    public com.fedex.ship.ShipmentEventNotificationSpecification[] getEventNotifications() {
        return eventNotifications;
    }
     ...
     */
    public void setEventNotifications(com.fedex.ship.ShipmentEventNotificationSpecification[] eventNotifications) {
        this.eventNotifications = eventNotifications;
    }

    public com.fedex.ship.ShipmentEventNotificationSpecification getEventNotifications(int i) {
        return this.eventNotifications[i];
    }

    public void setEventNotifications(int i, com.fedex.ship.ShipmentEventNotificationSpecification _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "ShipmentEventNotificationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("aggregationType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "AggregationType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "ShipmentNotificationAggregationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("personalMessage");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "PersonalMessage"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "EventNotifications"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "ShipmentEventNotificationSpecification"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
