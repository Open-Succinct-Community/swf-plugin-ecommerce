...
public class NaftaLowValueStatementDetail  implements java.io.Serializable {
    ...
    private com.fedex.ship.stub.CustomsRoleType role;

    public NaftaLowValueStatementDetail() {
    }

    public NaftaLowValueStatementDetail(
           com.fedex.ship.stub.CustomsRoleType role) {
           this.role = role;
    }
     ...
     */
    public com.fedex.ship.stub.CustomsRoleType getRole() {
        return role;
    }
     ...
     */
    public void setRole(com.fedex.ship.stub.CustomsRoleType role) {
        this.role = role;
    }
