...
public class AvailableImagesDetail  implements java.io.Serializable {
    private com.fedex.ship.AvailableImageType type;

    private com.fedex.ship.ImageSizeType size;

    public AvailableImagesDetail() {
    }

    public AvailableImagesDetail(
           com.fedex.ship.AvailableImageType type,
           com.fedex.ship.ImageSizeType size) {
           this.type = type;
           this.size = size;
    }
     ...
     * @return type
     */
    public com.fedex.ship.AvailableImageType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ship.AvailableImageType type) {
        this.type = type;
    }
     ...
     * @return size
     */
    public com.fedex.ship.ImageSizeType getSize() {
        return size;
    }
     ...
     * @param size
     */
    public void setSize(com.fedex.ship.ImageSizeType size) {
        this.size = size;
    }
