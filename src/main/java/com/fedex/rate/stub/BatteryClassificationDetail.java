...
public class BatteryClassificationDetail  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.BatteryMaterialType material;

    /* Describes the packing arrangement of the battery or cell with
     * respect to other items within the same package. */
    private com.fedex.rate.stub.BatteryPackingType packing;

    /* A regulation specific classification for the battery or cell. */
    private com.fedex.rate.stub.BatteryRegulatorySubType regulatorySubType;

    public BatteryClassificationDetail() {
    }

    public BatteryClassificationDetail(
           com.fedex.rate.stub.BatteryMaterialType material,
           com.fedex.rate.stub.BatteryPackingType packing,
           com.fedex.rate.stub.BatteryRegulatorySubType regulatorySubType) {
     ...
     */
    public com.fedex.rate.stub.BatteryMaterialType getMaterial() {
        return material;
    }
     ...
     */
    public void setMaterial(com.fedex.rate.stub.BatteryMaterialType material) {
        this.material = material;
    }
     ...
     * respect to other items within the same package.
     */
    public com.fedex.rate.stub.BatteryPackingType getPacking() {
        return packing;
    }
     ...
     * respect to other items within the same package.
     */
    public void setPacking(com.fedex.rate.stub.BatteryPackingType packing) {
        this.packing = packing;
    }
     ...
     */
    public com.fedex.rate.stub.BatteryRegulatorySubType getRegulatorySubType() {
     ...
     */
    public void setRegulatorySubType(com.fedex.rate.stub.BatteryRegulatorySubType regulatorySubType) {
        this.regulatorySubType = regulatorySubType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "BatteryClassificationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("material");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "Material"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "BatteryMaterialType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("packing");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "Packing"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "BatteryPackingType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("regulatorySubType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "RegulatorySubType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "BatteryRegulatorySubType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
