...
public class TrackChargeDetail  implements java.io.Serializable {
    private com.fedex.ship.TrackChargeDetailType type;

    private com.fedex.ship.Money chargeAmount;

    public TrackChargeDetail() {
    }

    public TrackChargeDetail(
           com.fedex.ship.TrackChargeDetailType type,
           com.fedex.ship.Money chargeAmount) {
           this.type = type;
     ...
     * @return type
     */
    public com.fedex.ship.TrackChargeDetailType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ship.TrackChargeDetailType type) {
        this.type = type;
    }
     ...
     * @return chargeAmount
     */
    public com.fedex.ship.Money getChargeAmount() {
        return chargeAmount;
    }
     ...
     * @param chargeAmount
     */
    public void setChargeAmount(com.fedex.ship.Money chargeAmount) {
        this.chargeAmount = chargeAmount;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackChargeDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackChargeDetailType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("chargeAmount");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "ChargeAmount"));
