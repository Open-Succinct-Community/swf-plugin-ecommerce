...
public class ServiceDescription  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.ProductName[] names;
    ...
    public ServiceDescription(
           ...
           com.fedex.rate.stub.ProductName[] names,
     ...
     */
    public com.fedex.rate.stub.ProductName[] getNames() {
        return names;
    }
     ...
     */
    public void setNames(com.fedex.rate.stub.ProductName[] names) {
        this.names = names;
    }

    public com.fedex.rate.stub.ProductName getNames(int i) {
        return this.names[i];
    }

    public void setNames(int i, com.fedex.rate.stub.ProductName _value) {
        this.names[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ServiceDescription"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "Code"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "Names"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ProductName"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "AstraDescription"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
