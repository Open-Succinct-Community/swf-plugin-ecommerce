...
public class RatedShipmentDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "RatedShipmentDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ShipmentRateDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ShipmentRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ratedPackages");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "RatedPackages"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "RatedPackageDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
