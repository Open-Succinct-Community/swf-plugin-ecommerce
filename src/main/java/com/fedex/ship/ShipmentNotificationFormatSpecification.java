...
public class ShipmentNotificationFormatSpecification  implements java.io.Serializable {
    private com.fedex.ship.NotificationFormatType type;

    public ShipmentNotificationFormatSpecification() {
    }

    public ShipmentNotificationFormatSpecification(
           com.fedex.ship.NotificationFormatType type) {
           this.type = type;
    }
     ...
     * @return type
     */
    public com.fedex.ship.NotificationFormatType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ship.NotificationFormatType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "ShipmentNotificationFormatSpecification"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "NotificationFormatType"));
