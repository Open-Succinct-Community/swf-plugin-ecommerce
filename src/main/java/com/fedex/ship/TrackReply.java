...
public class TrackReply  implements java.io.Serializable {
    ...
    private com.fedex.ship.CompletedTrackDetail[] completedTrackDetails;
    ...
    public TrackReply(
           ...
           com.fedex.ship.CompletedTrackDetail[] completedTrackDetails) {
     ...
     */
    public com.fedex.ship.CompletedTrackDetail[] getCompletedTrackDetails() {
     ...
     */
    public void setCompletedTrackDetails(com.fedex.ship.CompletedTrackDetail[] completedTrackDetails) {
        this.completedTrackDetails = completedTrackDetails;
    }

    public com.fedex.ship.CompletedTrackDetail getCompletedTrackDetails(int i) {
        return this.completedTrackDetails[i];
    }

    public void setCompletedTrackDetails(int i, com.fedex.ship.CompletedTrackDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "CompletedTrackDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "CompletedTrackDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
