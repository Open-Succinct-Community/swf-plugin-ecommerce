...
public class NaftaCommodityDetail  implements java.io.Serializable {
    ...
    private com.fedex.ship.NaftaPreferenceCriterionCode preferenceCriterion;

    /* Defined by NAFTA regulations. */
    private com.fedex.ship.NaftaProducerDeterminationCode producerDetermination;
    ...
    private com.fedex.ship.NaftaNetCostMethodCode netCostMethod;

    /* Date range over which RVC net cost was calculated. */
    private com.fedex.ship.DateRange netCostDateRange;

    public NaftaCommodityDetail() {
    }

    public NaftaCommodityDetail(
           com.fedex.ship.NaftaPreferenceCriterionCode preferenceCriterion,
           com.fedex.ship.NaftaProducerDeterminationCode producerDetermination,
           java.lang.String producerId,
           com.fedex.ship.NaftaNetCostMethodCode netCostMethod,
           com.fedex.ship.DateRange netCostDateRange) {
     ...
     */
    public com.fedex.ship.NaftaPreferenceCriterionCode getPreferenceCriterion() {
     ...
     */
    public void setPreferenceCriterion(com.fedex.ship.NaftaPreferenceCriterionCode preferenceCriterion) {
        this.preferenceCriterion = preferenceCriterion;
    }
     ...
     */
    public com.fedex.ship.NaftaProducerDeterminationCode getProducerDetermination() {
     ...
     */
    public void setProducerDetermination(com.fedex.ship.NaftaProducerDeterminationCode producerDetermination) {
        this.producerDetermination = producerDetermination;
    }
     ...
     */
    public com.fedex.ship.NaftaNetCostMethodCode getNetCostMethod() {
        return netCostMethod;
    }
     ...
     * @param netCostMethod
     */
    public void setNetCostMethod(com.fedex.ship.NaftaNetCostMethodCode netCostMethod) {
        this.netCostMethod = netCostMethod;
    }
     ...
     */
    public com.fedex.ship.DateRange getNetCostDateRange() {
     ...
     */
    public void setNetCostDateRange(com.fedex.ship.DateRange netCostDateRange) {
        this.netCostDateRange = netCostDateRange;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "NaftaCommodityDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("preferenceCriterion");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "PreferenceCriterion"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "NaftaPreferenceCriterionCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("producerDetermination");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "ProducerDetermination"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "NaftaProducerDeterminationCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("producerId");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "ProducerId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "NetCostMethod"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "NaftaNetCostMethodCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("netCostDateRange");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "NetCostDateRange"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "DateRange"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
