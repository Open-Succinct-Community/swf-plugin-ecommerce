...
public class DeliveryOptionEligibilityDetail  implements java.io.Serializable {
    ...
    private com.fedex.ship.DeliveryOptionType option;

    /* Eligibility of the customer for the specific delivery option. */
    private com.fedex.ship.EligibilityType eligibility;

    public DeliveryOptionEligibilityDetail() {
    }

    public DeliveryOptionEligibilityDetail(
           com.fedex.ship.DeliveryOptionType option,
           com.fedex.ship.EligibilityType eligibility) {
           this.option = option;
     ...
     */
    public com.fedex.ship.DeliveryOptionType getOption() {
        return option;
    }
     ...
     */
    public void setOption(com.fedex.ship.DeliveryOptionType option) {
        this.option = option;
    }
     ...
     */
    public com.fedex.ship.EligibilityType getEligibility() {
        return eligibility;
    }
     ...
     */
    public void setEligibility(com.fedex.ship.EligibilityType eligibility) {
        this.eligibility = eligibility;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "DeliveryOptionEligibilityDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("option");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Option"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "DeliveryOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("eligibility");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Eligibility"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "EligibilityType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
