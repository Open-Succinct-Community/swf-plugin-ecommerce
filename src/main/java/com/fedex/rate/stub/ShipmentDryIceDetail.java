...
public class ShipmentDryIceDetail  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.ShipmentDryIceProcessingOptionsRequested processingOptions;
    ...
    public ShipmentDryIceDetail(
           ...
           com.fedex.rate.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
     ...
     */
    public com.fedex.rate.stub.ShipmentDryIceProcessingOptionsRequested getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.fedex.rate.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
        this.processingOptions = processingOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ShipmentDryIceDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v24", "ShipmentDryIceProcessingOptionsRequested"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
