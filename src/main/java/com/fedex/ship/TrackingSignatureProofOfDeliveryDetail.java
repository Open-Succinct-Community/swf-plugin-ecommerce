...
public class TrackingSignatureProofOfDeliveryDetail  implements java.io.Serializable {
    private com.fedex.ship.TrackingDocumentFormat documentFormat;

    public TrackingSignatureProofOfDeliveryDetail() {
    }

    public TrackingSignatureProofOfDeliveryDetail(
           com.fedex.ship.TrackingDocumentFormat documentFormat) {
     ...
     */
    public com.fedex.ship.TrackingDocumentFormat getDocumentFormat() {
        return documentFormat;
    }
     ...
     */
    public void setDocumentFormat(com.fedex.ship.TrackingDocumentFormat documentFormat) {
        this.documentFormat = documentFormat;
    }
