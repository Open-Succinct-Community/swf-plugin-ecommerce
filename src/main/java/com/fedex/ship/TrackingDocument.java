...
public class TrackingDocument  implements java.io.Serializable {
    private com.fedex.ship.TrackingDocumentType type;

    private com.fedex.ship.Localization[] localizations;

    private com.fedex.ship.TrackingDocumentImageType imageType;

    private org.apache.axis.types.NonNegativeInteger resolution;

    private com.fedex.ship.DocumentPart[] parts;

    public TrackingDocument() {
    }

    public TrackingDocument(
           com.fedex.ship.TrackingDocumentType type,
           com.fedex.ship.Localization[] localizations,
           com.fedex.ship.TrackingDocumentImageType imageType,
           org.apache.axis.types.NonNegativeInteger resolution,
           com.fedex.ship.DocumentPart[] parts) {
           this.type = type;
     ...
     * @return type
     */
    public com.fedex.ship.TrackingDocumentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ship.TrackingDocumentType type) {
        this.type = type;
    }
     ...
     */
    public com.fedex.ship.Localization[] getLocalizations() {
        return localizations;
    }
     ...
     * @param localizations
     */
    public void setLocalizations(com.fedex.ship.Localization[] localizations) {
        this.localizations = localizations;
    }

    public com.fedex.ship.Localization getLocalizations(int i) {
        return this.localizations[i];
    }

    public void setLocalizations(int i, com.fedex.ship.Localization _value) {
     ...
     * @return parts
     */
    public com.fedex.ship.DocumentPart[] getParts() {
        return parts;
    }
     ...
     * @param parts
     */
    public void setParts(com.fedex.ship.DocumentPart[] parts) {
        this.parts = parts;
    }

    public com.fedex.ship.DocumentPart getParts(int i) {
        return this.parts[i];
    }

    public void setParts(int i, com.fedex.ship.DocumentPart _value) {
        this.parts[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackingDocument"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Localizations"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Resolution"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "Parts"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "DocumentPart"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
