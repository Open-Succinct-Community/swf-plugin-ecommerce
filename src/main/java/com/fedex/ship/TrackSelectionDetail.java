...
public class TrackSelectionDetail  implements java.io.Serializable {
     ...
     * packages. */
    private com.fedex.ship.TrackPackageIdentifier packageIdentifier;
    ...
    private com.fedex.ship.PagingDetail pagingDetail;
    ...
    public TrackSelectionDetail(
           ...
           com.fedex.ship.TrackPackageIdentifier packageIdentifier,
           ...
           com.fedex.ship.PagingDetail pagingDetail,
     ...
     * packages.
     */
    public com.fedex.ship.TrackPackageIdentifier getPackageIdentifier() {
     ...
     * packages.
     */
    public void setPackageIdentifier(com.fedex.ship.TrackPackageIdentifier packageIdentifier) {
        this.packageIdentifier = packageIdentifier;
    }
     ...
     * pages when there is more than one page in the TrackReply.
     */
    public com.fedex.ship.PagingDetail getPagingDetail() {
        return pagingDetail;
    }
     ...
     * pages when there is more than one page in the TrackReply.
     */
    public void setPagingDetail(com.fedex.ship.PagingDetail pagingDetail) {
        this.pagingDetail = pagingDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackSelectionDetail"));
