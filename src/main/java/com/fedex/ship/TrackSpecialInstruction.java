...
public class TrackSpecialInstruction  implements java.io.Serializable {
    ...
    private com.fedex.ship.TrackDeliveryOptionType deliveryOption;

    /* Specifies the status and status update time of the track special
     * instructions. */
    private com.fedex.ship.SpecialInstructionStatusDetail statusDetail;
    ...
    private com.fedex.ship.AppointmentDetail requestedAppointmentTime;
    ...
    public TrackSpecialInstruction(
           ...
           com.fedex.ship.TrackDeliveryOptionType deliveryOption,
           com.fedex.ship.SpecialInstructionStatusDetail statusDetail,
           java.util.Calendar originalEstimatedDeliveryTimestamp,
           java.util.Calendar originalRequestTime,
           com.fedex.ship.AppointmentDetail requestedAppointmentTime) {
     ...
     */
    public com.fedex.ship.TrackDeliveryOptionType getDeliveryOption() {
        return deliveryOption;
    }
     ...
     */
    public void setDeliveryOption(com.fedex.ship.TrackDeliveryOptionType deliveryOption) {
        this.deliveryOption = deliveryOption;
    }
     ...
     * instructions.
     */
    public com.fedex.ship.SpecialInstructionStatusDetail getStatusDetail() {
        return statusDetail;
    }
     ...
     * instructions.
     */
    public void setStatusDetail(com.fedex.ship.SpecialInstructionStatusDetail statusDetail) {
        this.statusDetail = statusDetail;
    }
     ...
     */
    public com.fedex.ship.AppointmentDetail getRequestedAppointmentTime() {
     ...
     */
    public void setRequestedAppointmentTime(com.fedex.ship.AppointmentDetail requestedAppointmentTime) {
        this.requestedAppointmentTime = requestedAppointmentTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackSpecialInstruction"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "DeliveryOption"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "TrackDeliveryOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "SpecialInstructionStatusDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("originalEstimatedDeliveryTimestamp");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "OriginalEstimatedDeliveryTimestamp"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "OriginalRequestTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "RequestedAppointmentTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v16", "AppointmentDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
